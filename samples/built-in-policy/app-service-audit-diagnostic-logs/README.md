...
$definition
$assignment = New-AzureRMPolicyAssignment -Name <assignmentname> -Scope <scope> -effect <effect> -type <type> -PolicyDefinition $definition
$assignment 
````
...
az policy assignment create --name <assignmentname> --scope <scope> --type <type> --policy "app-service-audit-diagnostic-logs" 
