...
function Get-WindowsFeatureInternal
{
    ...
    $null = Invoke-Command -ScriptBlock {param ($fileName) powershell -command "Get-WindowsFeature -Name Web-Server | ConvertTo-Json | Out-File $fileName"} -args $tmpfileName
